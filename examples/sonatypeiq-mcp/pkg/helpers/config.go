...
//  2. Static bearer token from config (or web_token_file)
//
...
func GetUpstreamToken() string {
	...
	if cfg != nil {
		...
		if cfg.Auth.Backend.Static.WebToken != "" {
			return cfg.Auth.Backend.Static.WebToken
		}
		if cfg.Auth.Backend.Static.WebTokenFile != "" {
			if data, err := os.ReadFile(cfg.Auth.Backend.Static.WebTokenFile); err == nil {
