...
USAGE
  ...
  ./client.sh call AcknowledgeErrors '{}'
EOEX
  cat <<'EOEX'
  # AddActorUsers (POST)
  ./client.sh call AddActorUsers '{"id": 0, "projectIdOrKey": "projectIdOrKey_value", "body": {"empty": false}}'
EOEX
  cat <<'EOEX'
  # AddAttachment (POST) — uploads a file
  ./client.sh call AddAttachment '{}' --file /path/to/file
EOEX
  cat <<'EOEX'
  # AddComment (POST)
  ./client.sh call AddComment '{"expand": "expand_value", "issueIdOrKey": "issueIdOrKey_value", "body": {"created": "2012-07-06T18:30:00.000+0000", "self": "http://www.example.com/jira/rest/api/2/issue/10010/comment/10000", "updated": "2012-07-06T18:30:00.000+0000", "visibility": {}, "author": {}, "updateAuthor": "value", "body": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eget venenatis elit. Duis eu justo eget augue iaculis fermentum. Sed semper quam laoreet nisi egestas at posuere augue semper.", "properties": [], "id": "10000", "renderedBody": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eget venenatis elit. Duis eu justo eget augue iaculis fermentum. Sed semper quam laoreet nisi egestas at posuere augue semper."}}'
EOEX
  cat <<'EOEX'
  # AddField (POST)
  ./client.sh call AddField '{"screenId": 0, "tabId": 0, "body": {"fieldId": "summary"}}'
EOEX
  cat <<'EOEX'
  # AddFieldToDefaultScreen (POST)
  ./client.sh call AddFieldToDefaultScreen '{"fieldId": "fieldId_value"}'
EOEX
  cat <<'EOEX'
  # AddProjectAssociationsToScheme (POST)
  ./client.sh call AddProjectAssociationsToScheme '{"schemeId": "schemeId_value", "body": {"idsOrKeys": ["100034","13543","FOOPROJ","BAZZPROJ"]}}'
EOEX
  cat <<'EOEX'
  # AddProjectRoleActorsToRole (POST)
  ./client.sh call AddProjectRoleActorsToRole '{"id": 0, "body": {"group": [], "user": []}}'
EOEX
  cat <<'EOEX'
  # AddSharePermission (POST)
  ./client.sh call AddSharePermission '{"id": "id_value", "body": {"type": "type_value", "userKey": "userKey_value", "view": false, "edit": false, "groupname": "groupname_value", "projectId": "projectId_value", "projectRoleId": "projectRoleId_value"}}'
EOEX
  cat <<'EOEX'
  # AddTab (POST)
  ./client.sh call AddTab '{"screenId": 0, "body": {"id": 10000, "name": "Fields Tab"}}'
EOEX
  cat <<'EOEX'
  # AddUserToApplication1 (POST)
  ./client.sh call AddUserToApplication1 '{"applicationKey": "applicationKey_value", "username": "username_value"}'
EOEX
  cat <<'EOEX'
  # AddUserToGroup (POST)
  ./client.sh call AddUserToGroup '{"groupname": "groupname_value", "body": {"name": "charlie"}}'
EOEX
  cat <<'EOEX'
  # AddVote (POST)
  ./client.sh call AddVote '{"issueIdOrKey": "issueIdOrKey_value"}'
EOEX
  cat <<'EOEX'
  # AddWatcher1 (POST)
  ./client.sh call AddWatcher1 '{"issueIdOrKey": "issueIdOrKey_value", "userName": "userName_value", "body": "value"}'
EOEX
  cat <<'EOEX'
  # AddWorklog (POST)
  ./client.sh call AddWorklog '{"adjustEstimate": "adjustEstimate_value", "issueIdOrKey": "issueIdOrKey_value", "newEstimate": "newEstimate_value", "reduceBy": "reduceBy_value", "body": {"timeSpent": "3h 20m", "created": "2010-07-14T18:23:23.733+0000", "comment": "I did some work here.", "started": "2010-07-14T18:23:23.733+0000", "visibility": {}, "author": "value", "id": "100028", "issueId": "10002", "self": "http://www.example.com/jira/rest/api/2/issue/10010/worklog/10000", "timeSpentSeconds": 12000, "updated": "2010-07-14T18:23:23.733+0000", "updateAuthor": {}}}'
EOEX
  cat <<'EOEX'
  # ApplyEmailTemplates (POST)
  ./client.sh call ApplyEmailTemplates '{}'
EOEX
  cat <<'EOEX'
  # ApproveUpgrade (POST)
  ./client.sh call ApproveUpgrade '{}'
EOEX
  cat <<'EOEX'
  # ArchiveIssue (PUT)
  ./client.sh call ArchiveIssue '{"issueIdOrKey": "issueIdOrKey_value", "notifyUsers": "notifyUsers_value"}'
EOEX
  cat <<'EOEX'
  # ArchiveIssues (POST)
  ./client.sh call ArchiveIssues '{"notifyUsers": "notifyUsers_value", "body": "value"}'
EOEX
  cat <<'EOEX'
  # ArchiveProject (PUT)
  ./client.sh call ArchiveProject '{"projectIdOrKey": "projectIdOrKey_value"}'
EOEX
}
