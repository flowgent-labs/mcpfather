...
# Run the HTTP mode
./bin/jira-mcp-v10.7.4 --transport http --port 8080 &

# Run the CLI mode
./bin/jira-mcp-v10.7.4 -t cli list
...
./bin/jira-mcp-v10.7.4 --print-default-config

# Create and edit your config
mkdir -p ~/.jira-mcp-v10.7.4
./bin/jira-mcp-v10.7.4 --print-default-config > ~/.jira-mcp-v10.7.4/config.yaml
```

Edit `~/.jira-mcp-v10.7.4/config.yaml` and set `tools.include` to the operation IDs you want:
...
export MCP_UPSTREAM_ENDPOINT=https://api.example.com
export MCP_UPSTREAM_TOKEN=your-token
./jira-mcp-v10.7.4 --transport http --port 8080
```
