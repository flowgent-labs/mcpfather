...
- Real Enterprise Virtual Tools definitions:
  - [sonarqube-example-config.yaml](./pkg/generator/skills/virtual-tool-creator/resources/sonarqube-example-config.yaml#L130)
  - [sonatypenexus-example-config.yaml](./pkg/generator/skills/virtual-tool-creator/resources/sonatypenexus-example-config.yaml#L141)
  - [sonatypeiq-example-config.yaml](./pkg/generator/skills/virtual-tool-creator/resources/sonatypeiq-example-config.yaml#L126)
...
This project is licensed under the AGPL License, but the Generated MCP servers exception, It will use a permissive standard Apache License 2.0. — see the [LICENSE](LICENSE) file for details.
