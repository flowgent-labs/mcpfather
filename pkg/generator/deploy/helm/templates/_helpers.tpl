...
*/}}
{{- define "__MCP_SERVER_NAME__.name" -}}
...
*/}}
{{- define "__MCP_SERVER_NAME__.fullname" -}}
...
*/}}
{{- define "__MCP_SERVER_NAME__.chart" -}}
...
Common labels
*/}}
{{- define "__MCP_SERVER_NAME__.labels" -}}
helm.sh/chart: {{ include "__MCP_SERVER_NAME__.chart" . | quote }}
{{ include "__MCP_SERVER_NAME__.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "__MCP_SERVER_NAME__.selectorLabels" -}}
app.kubernetes.io/name: {{ include "__MCP_SERVER_NAME__.name" . | quote }}
...
*/}}
{{- define "__MCP_SERVER_NAME__.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "__MCP_SERVER_NAME__.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
Secret name to use
*/}}
{{- define "__MCP_SERVER_NAME__.secretName" -}}
{{- if eq .Values.secret.provider "static" }}
{{- if .Values.secret.static.create }}
{{- include "__MCP_SERVER_NAME__.fullname" . }}-secret
{{- else }}
...
*/}}
{{- define "__MCP_SERVER_NAME__.useStaticSecret" -}}
...
*/}}
{{- define "__MCP_SERVER_NAME__.useGCPSecret" -}}
...
*/}}
{{- define "__MCP_SERVER_NAME__.useEnvoyGateway" -}}
...
*/}}
{{- define "__MCP_SERVER_NAME__.useNginxIngress" -}}
